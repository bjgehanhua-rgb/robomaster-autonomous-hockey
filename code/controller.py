...
4. Navigate to the puck shooting position.
...
SHOT_SHOT_DIRECTION_OFFSET = 0.00
...
# ---------------------------------------------------------------------------
# Arm and 270-degree shooting action
# ---------------------------------------------------------------------------
...
def run_grab_stage():
    ...
    try:
        ...
        node.stage = "done"
        node.get_logger().info(
            "Stick grabbed successfully. Starting shooting stage next."
        )
        return True
