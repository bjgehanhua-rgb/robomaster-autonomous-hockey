...
SHOT_ROTATION_ANGLE = 3*math.pi/2
SHOT_ROTATION_SPEED = 10
...
def main(args=None):
    ...
    try:
        # The robot is assumed to already be holding the hockey stick.
        # Do not open, close, or otherwise command the gripper here.
        run_shot_stage()

    except KeyboardInterrupt:
        print("\nHockey shooting sequence interrupted by user.")
