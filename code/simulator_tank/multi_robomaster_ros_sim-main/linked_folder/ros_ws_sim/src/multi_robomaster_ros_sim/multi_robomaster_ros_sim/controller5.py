...
SHOT_ROBOT_TO_PUCK_DISTANCE = 0.55
...
#   1. the pre-swing and final robot positions; and
#   2. the assumed puck point used for final alignment.
#
# Therefore, changing this value translates the whole shooting geometry
# without changing the relative robot-to-assumed-puck aiming direction.
